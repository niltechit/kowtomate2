CREATE TABLE [dbo].[Email_Queue] (
    ...
    CONSTRAINT [PK_Email_Queue] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Email_Queue_Common_FileServer] FOREIGN KEY ([FileServerId]) REFERENCES [dbo].[Common_FileServer] ([Id]),
    CONSTRAINT [FK_Email_Queue_Email_Queue] FOREIGN KEY ([EmailAccountId]) REFERENCES [dbo].[Email_SenderAccount] ([Id])
);
