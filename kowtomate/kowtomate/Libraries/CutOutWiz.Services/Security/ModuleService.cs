...
namespace CutOutWiz.Services.Security
{
    public class ModuleService:IModuleService
    {
        ...
        {
            return await _db.LoadDataUsingProcedure<Module, dynamic>(storedProcedure: "dbo.SP_Security_Module_GetAll", new { });
        }
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<List<Module>> GetAllWithDetails()
        {
            return await _db.LoadDataUsingProcedure<Module, dynamic>(storedProcedure: "dbo.SP_Security_Module_GetAllWithDetails", new { });
        }
        ...
        {
            var result = await _db.LoadDataUsingProcedure<Module, dynamic>(storedProcedure: "dbo.SP_Security_Module_GetById", new { ModuleId = moduleId });
        ...
        /// <param name="ModuleId"></param>
        /// <returns></returns>
        public async Task<Module> GetByObjectId(string objectId)
        {
            var result = await _db.LoadDataUsingProcedure<Module, dynamic>(storedProcedure: "dbo.SP_Security_Module_GetByObjectId", new { ObjectId = objectId });
            return result.FirstOrDefault();
        }
        ...
        /// <returns></returns>
        public async Task<Response<int>> Insert(Module module)
        {
        ...
        /// <param name="module"></param>
        /// <returns></returns>
        public async Task<Response<bool>> Update(Module module)
        {
        ...
        public List<TreeNode> GetTreeNodes(List<ModulePermissionViewModel> permissions)
        {
            ...
            {
                parent.ChildNodes = permissions.Where(f => f.ModuleObjectId == parent.Id).Select(n => new TreeNode { NodeType = "Permission", Id = n.PermissionObjectId,
                    Name = n.PermissionName }).ToList();
            }
