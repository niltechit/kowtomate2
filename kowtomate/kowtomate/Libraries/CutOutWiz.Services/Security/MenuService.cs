...
namespace CutOutWiz.Services.Security
{
    public class MenuService : IMenuService
    {
        ...
        {
            return await _db.LoadDataUsingProcedure<Menu, dynamic>(storedProcedure: "dbo.SP_Security_Menu_GetAll", new { });
        }
        ...
        {
            var result = await _db.LoadDataUsingProcedure<Menu, dynamic>(storedProcedure: "dbo.SP_Security_Menu_GetById", new { MenuId = menuId });
        ...
        /// <param name="MenuId"></param>
        /// <returns></returns>
        public async Task<Menu> GetByObjectId(string objectId)
        {
            var result = await _db.LoadDataUsingProcedure<Menu, dynamic>(storedProcedure: "dbo.SP_Security_Menu_GetByObjectId", new { ObjectId = objectId });
            return result.FirstOrDefault();
        }
        ...
        /// <returns></returns>
        public async Task<Response<int>> Insert(Menu menu)
        {
        ...
        /// <param name="menu"></param>
        /// <returns></returns>
        public async Task<Response<bool>> Update(Menu menu)
        {
