...
namespace CutOutWiz.Services.StorageService
{
    public interface IAwsService
    {
        ...
        Task<Response<List<Node>>> GetDirectories(AwsCredentialsModel awsCredentials, string prefix, string delimiter = "/");
        Task<Response<List<DriveImage>>> GetFilesByPath(AwsCredentialsModel awsCredentials, string prefix, bool loadRawImages = true);
