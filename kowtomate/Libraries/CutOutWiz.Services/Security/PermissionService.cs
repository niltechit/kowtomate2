...
namespace CutOutWiz.Services.Security
{
    public class PermissionService : IPermissionService
    {
        ...
        {
            return await _db.LoadDataUsingProcedure<PermissionModel, dynamic>(storedProcedure: "dbo.SP_Security_Permission_GetAll", new { });
        }
        ...
        {
            var result = await _db.LoadDataUsingProcedure<PermissionListModel, dynamic>(storedProcedure: "[dbo].[SP_Security_Permission_GetAllWithDetailsByObjectId]", new { ObjectId = permissionObjectId });
        ...
        {
            var result = await _db.LoadDataUsingProcedure<PermissionModel, dynamic>(storedProcedure: "dbo.SP_Security_Permission_GetById", new { PermissionId = permissionId });
            return result.FirstOrDefault();
        }
        ...
        {
            var result = await _db.LoadDataUsingProcedure<PermissionModel, dynamic>(storedProcedure: "dbo.SP_Security_Permission_GetByObjectId", new { ObjectId = objectId });
            return result.FirstOrDefault();
        }
        ...
        {
            return await _db.LoadDataUsingProcedure<PermissionModel, dynamic>(storedProcedure: "dbo.SP_Security_Permission_GetAllByUserId", new { UserObjectId = userObjectId });
        }
        #endregion
		...
		public async Task<List<PermissionModel>> GetAllPermissionByRoleObjectId(string roleObjectId)
		{
			...
			var result = await _db.LoadDataUsingProcedure<PermissionModel, dynamic>(storedProcedure: "dbo.GetRolePermissionByRoleObjectId", new { roleObjectId = roleObjectId });
			return result;
		}
	}
}
