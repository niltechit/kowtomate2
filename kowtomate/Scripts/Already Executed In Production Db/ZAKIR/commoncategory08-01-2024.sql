...
-- =============================================
CREATE PROCEDURE SP_Common_Category_DeleteById
...
-- =============================================
CREATE PROCEDURE SP_Common_Category_GetById
	-- Add the parameters for the stored procedure here
	@Id int
AS
BEGIN
    ...
    -- Insert statements for procedure here
	SELECT * FROM Common_Category with(nolock) WHERE Id = @Id
END
GO
...
-- =============================================
CREATE PROCEDURE SP_Common_Category_Update
    @Id INT,
    @Name NVARCHAR(MAX),
...
-- =============================================
CREATE PROCEDURE SP_Common_Category_Insert
    @Name NVARCHAR(MAX),
    @TimeInMinutes DECIMAL,
    @PriceInUSD DECIMAL,
    @IsActive BIT,
...
-- =============================================
CREATE PROCEDURE SP_Common_Category_GetAll 
	-- Add the parameters for the stored procedure here
...
BEGIN
    ...
    -- Insert statements for procedure here
	SELECT * FROM Common_Category with(nolock) where IsActive = 1 and IsDeleted = 0;
END
GO
